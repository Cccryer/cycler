...
from graph.base.base_indexer import BaseIndexer
from graph.base.connection_manager import connection_manager
...
class EntityIndexManager(BaseIndexer):
    ...
    def __init__(self, refresh_schema: bool = True, batch_size: int = 100, max_workers: int = 4):
        ...
        # 初始化模型
        self.embeddings = ModelManager.get_instance().get_or_create_embedding_model(
            name="entity_embedding",
            model_type="openai_embedding",
        )

        self.llm = ModelManager.get_instance().get_or_create_chat_model(
            name="entity_llm",
    ...
    def _process_embeddings_in_batches(self, entities: List[Dict[str, Any]], 
        ...
        def process_batch(batch, batch_index):
            ...
            embeddings = self.embeddings.embed_batch(entity_texts)
