...
from graph.base.base_indexer import generate_hash
...
class GraphStructureBuilder:
    ...
    def create_relation_between_chunks(self, file_name: str, chunks: List) -> List[Dict]:
        ...
        for i, chunk in enumerate(chunks):
            ...
            current_chunk_id = gen_sha512_hash(page_content)
            position = i + 1
            previous_chunk_id = current_chunk_id if i == 0 else lst_chunks_including_hash[-1]['chunk_id'] #前向关系
